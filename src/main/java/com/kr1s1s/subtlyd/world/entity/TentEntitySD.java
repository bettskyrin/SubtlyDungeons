...
public class TentEntitySD extends Entity {
    public long lastHit;
    private Boolean occupied;
    private final Supplier<Item> dropItem;
    public DyeColor color;

    public TentEntitySD(EntityType<?> entityType, Level level, Supplier<Item> supplier, DyeColor color) {
    ...
    public static final ResourceKey<EntityType<?>> TENT_ENTITY = ResourceKey.create(Registries.ENTITY_TYPE, TentEntitySD.getLocation());

    public static ResourceLocation getLocation() {
        return ResourceLocation.fromNamespaceAndPath(SubtlyDungeons.MOD_ID, "tent_entity");
    }
