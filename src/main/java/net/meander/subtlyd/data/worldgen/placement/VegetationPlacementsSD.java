...
public class VegetationPlacementsSD {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        context.register(WILDFLOWERS_BIRCH_FOREST, new PlacedFeature(
                configuredFeatures.getOrThrow(VegetationFeaturesSD.WILDFLOWER),
                List.of(
                        CountPlacement.of(3),
        ...
        context.register(WILDFLOWERS_MEADOW, new PlacedFeature(
                        configuredFeatures.getOrThrow(VegetationFeaturesSD.WILDFLOWER),
                        List.of(
                                CountPlacement.of(3),
                                RarityFilter.onAverageOnceEvery(2),
