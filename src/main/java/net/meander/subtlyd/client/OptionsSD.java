...
public class OptionsSD {
    ...
    public static final Component ACCESSIBILITY_TOOLTIP_SHIELD_CROUCH = Component.translatable("options.accessibility.shield_crouch.tooltip");
    public static final Component VIDEO_TOOLTIP_ADVANCED_ENTITY_ANIMATIONS = Component.translatable("options.advanced_entity_animations.tooltip");
    public static final Component ACCESSIBILITY_TOOLTIP_SHIELD_ANIMATION = Component.translatable("options.accessibility.shield_animation.tooltip");
