...
public class HugeRedMushroomFeatureMixin {
    ...
    private int modifyCapShape(int originalDepth, @Local(name = "random", argsOnly = true) RandomSource random) {
        return originalDepth - random.nextIntBetweenInclusive(0, 1);
    }
}
