...
public class AttributesSD {
    public static final Holder<Attribute> SHIELD_STRENGTH = register("shield_strength", new RangedAttribute("attribute.name.subtlyd.shield_strength", 5.0, 0.0, 1024.0).setSyncable(true));
